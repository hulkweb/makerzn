...
@section('content')
    ...
    <section class="page-title mb-3">
        ...
        <div class="auto-container">
            <h2>{{ setting('site_name') }} Faqs | Cryptocurrency Cloud Mining Platform</h2>
            <ul class="bread-crumb clearfix">
                <li><a href="home.html">Home</a></li>
                <li>
                    {{ setting('site_name') }} Faqs | Cryptocurrency Cloud Mining Platform
                </li>
            </ul>
        </div>
    </section>
                                            ...
                                            <p>
                                                <font color="#ffffff">You can easily
                                                    ...
                                                    <a href="cdn-cgi/l/email-protection.html" class="__cf_email__"
                                                        data-cfemail="6c1f191c1c031e182c210d1f240d1f0442020918">[email&#160;protected]</a>
                                                    for any questions
                                                    about our cloud
                                                    mining services,
                                                    crypto mining, or
                ...
                <div class="column col-lg-6 col-md-12 col-sm-12">
                    ...
                    <div class="faq-phone_box">
                        ...
                        <a href="tel:+1-678-772-6710"><span class="__cf_email__"
                                data-cfemail="4f3c3a3f3f203d3b0f222e3c272e3c27612c2022">[email&#160;protected]</span></a>
                    </div>
